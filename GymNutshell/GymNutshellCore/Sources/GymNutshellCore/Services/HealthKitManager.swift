...
public final class HealthKitManager: @unchecked Sendable {
    ...
    public static func displayName(for type: HKWorkoutActivityType) -> String {
        switch type {
        case .running:                      return String(localized: "healthkit.activity.running", bundle: .module)
        case .walking:                      return String(localized: "healthkit.activity.walking", bundle: .module)
        case .cycling:                      return String(localized: "healthkit.activity.cycling", bundle: .module)
        case .swimming:                     return String(localized: "healthkit.activity.swimming", bundle: .module)
        case .elliptical:                   return String(localized: "healthkit.activity.elliptical", bundle: .module)
        case .rowing:                       return String(localized: "healthkit.activity.rowing", bundle: .module)
        case .stairClimbing:                return String(localized: "healthkit.activity.stairClimbing", bundle: .module)
        case .hiking:                       return String(localized: "healthkit.activity.hiking", bundle: .module)
        case .jumpRope:                     return String(localized: "healthkit.activity.jumpRope", bundle: .module)
        case .cardioDance, .socialDance:    return String(localized: "healthkit.activity.dance", bundle: .module)
        case .traditionalStrengthTraining:  return String(localized: "healthkit.activity.strengthTraining", bundle: .module)
        case .functionalStrengthTraining:   return String(localized: "healthkit.activity.functionalTraining", bundle: .module)
        case .crossTraining:                return String(localized: "healthkit.activity.crossTraining", bundle: .module)
        case .highIntensityIntervalTraining: return String(localized: "healthkit.activity.hiit", bundle: .module)
        case .boxing:                       return String(localized: "healthkit.activity.boxing", bundle: .module)
        case .martialArts:                  return String(localized: "healthkit.activity.martialArts", bundle: .module)
        case .coreTraining:                 return String(localized: "healthkit.activity.coreTraining", bundle: .module)
        case .climbing:                     return String(localized: "healthkit.activity.climbing", bundle: .module)
        default:                            return String(localized: "healthkit.activity.other", bundle: .module)
        }
    }
